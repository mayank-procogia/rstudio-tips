...
subtitle: "<span style='color:white; text-shadow: 2px 2px 3px #91bd02;'>Tips and Tricks for improving RStudio IDE Development Efficiency</span>"
...
# Personalize your RStudio IDE {background-image="data/personalize-settings.jpg"  background-size="250px" background-position="right 10% bottom 10%"}
...
# Navigating your RStudio IDE {background-image="data/navigate.jpg"  background-size="250px" background-position="right 10% bottom 10%"}
...
# Keyboard Shortcuts {background-image="data/keyboard-typing.jpg"  background-size="250px" background-position="right 10% bottom 10%"}
...
# References {background-image="data/thinking.jpg"  background-size="250px" background-position="right 10% bottom 10%"}
